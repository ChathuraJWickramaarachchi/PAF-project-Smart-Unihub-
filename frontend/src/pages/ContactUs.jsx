    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative py-20 lg:py-28 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 overflow-hidden">
        <div className="absolute inset-0 opacity-30">
          ...
          <div className="absolute bottom-20 left-20 w-96 h-96 bg-blue-600/15 rounded-full blur-3xl"></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {contactInfo.map((info, index) => (
              <div key={index} className="group bg-white rounded-2xl border border-gray-200 p-6 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <div className={`inline-flex items-center justify-center w-14 h-14 rounded-xl bg-gradient-to-br ${info.color} text-white mb-5 group-hover:scale-110 transition-transform shadow-lg`}>
                ...
                <div className={`px-3 py-2 rounded-lg text-xs font-semibold flex items-center gap-2 ${
                  ...
                  {info.isLive && (
                    <span className={`relative flex h-2 w-2`}>
                      ...
                      <span className={`relative inline-flex rounded-full h-2 w-2 ${isOfficeOpen() ? 'bg-green-500' : 'bg-red-500'}`}></span>
                    </span>
                  )}
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            {/* Contact Form */}
            <div className="lg:col-span-2 bg-white p-8 lg:p-10 rounded-2xl border border-gray-200 shadow-sm">
              <div className="mb-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-3 px-8 py-4 bg-primary text-white font-semibold rounded-xl hover:bg-primary-dark transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-primary/25 hover:shadow-xl hover:shadow-primary/30 hover:-translate-y-0.5"
                >
                  {isSubmitting ? (
                    <>
